...
namespace WebPush.Util
{
	...
	internal static class Encryptor
	{
		...
		private static Byte[] GenerateSalt(Int32 length)
		{
		...
		public static Byte[] HKDFSecondStep(Byte[] key, Byte[] info, Int32 length)
		{
		...
		public static Byte[] HKDF(Byte[] salt, Byte[] prk, Byte[] info, Int32 length)
		{
		...
		public static Byte[] ConvertInt(Int32 number)
		{
